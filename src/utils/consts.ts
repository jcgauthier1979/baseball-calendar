...
export const COLOR_SC1: string ="#0066cc";
export const COLOR_SC2: string ="#0077cc";
export const COLOR_SC3: string ="#0088cc";
export const COLOR_SC4: string ="#0099cc";
export const COLOR_SC5: string ="#00aacc";
export const COLOR_SCC1: string ="#00bbcc";
export const COLOR_SCC2: string ="#00cccc";
