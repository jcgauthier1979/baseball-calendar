...
export const ORGANIZATION : string = "ASSOCIATION DE BASEBALL AMATEUR D'AYLMER";
export const SECONDARY_ORGANIZATION : string = "ASSOCIATION BASEBALL AMATEUR DE HULL";
